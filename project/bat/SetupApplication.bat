...
:: Android packaging
set AND_CERT_NAME="CastleBuilder"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CastleBuilder.p12
...
set IOS_PROVISION=cert\CastleBuilder.mobileprovision
...
set APP_ID=air.CastleBuilder

:: Output packages
set DIST_PATH=dist
set DIST_NAME=CastleBuilder
